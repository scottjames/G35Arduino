...
// SAJ - remove StockPrograms, only use PlusPrograms (more interesting!)
...
//SAJ set to 36 for my GE lights.
...
// SAJ -- remove 'stock' program, only use plus programs.

const int PROGRAM_COUNT =
//  StockProgramGroup::ProgramCount +
